...
에디터에 코드를 붙여넣고, 용지 레이아웃과 글꼴·여백을 조정하여 인쇄해 보세요.
...
- 🎨 **구문 강조 & 커스터마이징**: 글꼴(D2Coding 등), 글자 크기, 여백, 줄 간격을 정밀하게 조정 가능합니다.
- 🔍 **찾기 및 바꾸기**: 에디터 내에서 편리하게 코드 내용을 검색하고 일괄 변경할 수 있습니다.
- 🤖 **AI 에이전트 API**: URL 파라미터와 `window.codePrinter` API로 설정·코드 조작을 자동화할 수 있습니다. ([llms.txt](./public/llms.txt))
...
3. 오른쪽 컨트롤 패널에서 단수(1단/2단), 글꼴, 여백 등을 원하는 스타일로 조정합니다.
...
[GitHub Issues](https://github.com/ddunddun-labs/code-printer/issues) 또는 [기여 가이드라인](CONTRIBUTING.md)을 참조해 주세요.
